	...
	<table>
		<form action="<?php echo base_url('c_mahasiswa/ubahmhs'); ?>" method="POST">
			...
			<tr>
				...
				<td>
					<select name="jkl">
						<option value="Laki-laki" ?php echo $itemmhs[jns_kelamin] == Laki-laki?selecte: ?>Laki-laki</option>
						<option value="Perempuan" ?php echo $itemmhs[jns_kelamin] == Perempuan?selecte:?>Perempuan</option>		
					</select>
				</td>
			</tr>
			<tr>
